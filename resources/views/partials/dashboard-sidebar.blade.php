...
<div class="dashboard-sidebar">
    <nav class="dashboard-nav">
        ...
        <a href="{{ route('admin.points.index') }}" class="dashboard-nav-link {{ str_starts_with($currentRoute, 'admin.points') ? 'active' : '' }}">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('admin.categories.index') }}" class="dashboard-nav-link {{ str_starts_with($currentRoute, 'admin.categories') ? 'active' : '' }}">
            <svg width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
