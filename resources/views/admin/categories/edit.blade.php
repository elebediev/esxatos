...
<div class="dashboard-page">
    ...
    <div class="dashboard-content">
        <div class="form-header">
            <h1 class="dashboard-title">Редактировать категорию</h1>
            <a href="{{ route('admin.categories.index', ['parent' => $category->parent_id]) }}" class="btn-back">
        ...
        <div class="form-card">
            <form action="{{ route('admin.categories.update', $category) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="slug" id="slug" class="form-input" value="{{ old('slug', $category->slug) }}" placeholder="Оставьте пустым для автогенерации">
                    <p class="form-hint">URL-дружественный идентификатор. Будет сгенерирован автоматически, если оставить пустым.</p>
                </div>

                <div class="form-group">
                    <label for="description" class="form-label">Описание</label>
                    <textarea name="description" id="description" class="form-textarea" rows="3">{{ old('description', $category->description) }}</textarea>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group form-group-half">
                        ...
                        <input type="number" name="weight" id="weight" class="form-input" value="{{ old('weight', $category->weight) }}">
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('admin.categories.index', ['parent' => $category->parent_id]) }}" class="btn-cancel">Отмена</a>
                </div>
            </form>
        </div>
        ...
        <div class="category-info-card">
            ...
            <dl class="info-list">
                ...
                <div class="info-item">
                    <dt>Drupal TID:</dt>
                    <dd>{{ $category->drupal_tid }}</dd>
                </div>
                @endif
                <div class="info-item">
                    <dt>Книг в категории:</dt>
